...
extension WeatherClient {
  ...
  public static let empty = Self(weather: { _ in
  ...
  public static let happyPath = Self(weather: { _ in
    Just(
      WeatherResponse(
        consolidatedWeather: [
    ...
    Just([Location(title: "Dakar", woeid: 1)])
      .setFailureType(to: Error.self)
      .eraseToAnyPublisher()
  })
  
  
  public static let failed = Self(weather: { _ in
